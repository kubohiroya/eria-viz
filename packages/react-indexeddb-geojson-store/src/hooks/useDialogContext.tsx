...
const DialogContext = React.createContext<DialogContextValue>(defaultDialogContextValue);

export const DialogContextProvider = ({children}: {children: ReactNode})=>{
    const [currentStepIndex, setCurrentStepIndex] = useState<number>(defaultDialogContextValue.currentStepIndex);
    const [completedStepIndex, setCompletedStepIndex] = useState<number>(defaultDialogContextValue.completedStepIndex);
    const [isNextButtonEnabled, setNextButtonEnabled] = useState<boolean>(defaultDialogContextValue.isNextButtonEnabled);
    const [footer, setFooter] = useState<ReactNode>(defaultDialogContextValue.footer);
